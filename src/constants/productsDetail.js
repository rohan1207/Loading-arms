export const productsBySlug = {
  "loading-arms": {
    ...
    heroImage: "/products/loading-arms/hero.jpg",
    images: [
      "/products/loading-arms/01.jpg",
      "/products/loading-arms/02.jpg",
    ],
    intro: [
    ...
    gallery: Array.from({ length: 6 }, (_, i) => ({
      src: `/products/loading-arms/gallery-${String(i + 1).padStart(2, "0")}.jpg`,
  ...
  "unloading-arms": {
    ...
    heroImage: "/products/unloading-arms/hero.jpg",
    images: ["/products/unloading-arms/01.jpg", "/products/unloading-arms/02.jpg"],
    intro: [
    ...
    gallery: Array.from({ length: 4 }, (_, i) => ({
      src: `/products/unloading-arms/gallery-${String(i + 1).padStart(2, "0")}.jpg`,
  ...
  "floating-suction": {
    ...
    heroImage: "/products/floating-suction/hero.jpg",
    images: ["/products/floating-suction/01.jpg", "/products/floating-suction/02.jpg"],
    intro: [
    ...
    gallery: Array.from({ length: 6 }, (_, i) => ({
      src: `/products/floating-suction/gallery-${String(i + 1).padStart(2, "0")}.jpg`,
  ...
  "prover-tanks": {
    ...
    heroImage: "/products/prover-tanks/hero.jpg",
    images: ["/products/prover-tanks/01.jpg", "/products/prover-tanks/02.jpg"],
    intro: [
    ...
    gallery: Array.from({ length: 6 }, (_, i) => ({
      src: `/products/prover-tanks/gallery-${String(i + 1).padStart(2, "0")}.jpg`,
  ...
  "swivel-joints": {
    ...
    heroImage: "/products/swivel-joints/hero.jpg",
    images: ["/products/swivel-joints/01.jpg", "/products/swivel-joints/02.jpg"],
    intro: [
    ...
    gallery: Array.from({ length: 6 }, (_, i) => ({
      src: `/products/swivel-joints/gallery-${String(i + 1).padStart(2, "0")}.jpg`,
  ...
  "test-aiders": {
    ...
    heroImage: "/products/test-aiders/hero.jpg",
    images: ["/products/test-aiders/01.jpg", "/products/test-aiders/02.jpg"],
    intro: [
    ...
    gallery: Array.from({ length: 8 }, (_, i) => ({
      src: `/products/test-aiders/gallery-${String(i + 1).padStart(2, "0")}.jpg`,
